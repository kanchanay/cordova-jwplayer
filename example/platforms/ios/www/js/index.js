...
var app = {
    ...
    receivedEvent: function(id) {
        ...
        cordova.plugins.CordovaJWPlayer.setup({ autostart: false, onlyFullScreen : true }, function(result) {
            ...
            cordova.plugins.CordovaJWPlayer.setPlaylist([
                {
                    ...
                    mediaid : "100",
                    image : "https://traininglab-content.hypermartialarts.com/Trainers/tyler_mackensi/tyler_mackensi_kama_tricks.jpg",
                    sources : [
                        {
                ...
                },
                {
                    title : "Loren Cohen",
                    mediaid : "101",
                    image : "https://traininglab-content.hypermartialarts.com/Trainers/Hyper_Video_Poster.jpg",
                    sources : [ 
                        {
                ...
                },
                {
                    ...
                    sources : [ 
                        {
                            file : "https://video.hypermartialarts.com/vod/amlst:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJ3b3d6YSIsImlhdCI6MTQ3ODA1OTAwMiwiZXhwIjoxNDc4MTAyMjMyLCJtZWRpYSI6ImFtYXpvbnMzL2h5cGVydmlkZW8vZW5jb2RlZC9wcm90cmFpbmluZy90eWxlci1tYWNrZW5zaS1rYW1hLXRyaWNrcy9obWF0XzE1X1R5bGVyXzA4X1JlbGVhc2VfQ29tYm8ubXA0LnNtaWwifQ.FSCKHEgsO-bvWzuRuIUSjcHfkg4UvJKznkVt1qAK8SE/playlist.m3u8",
